public class Room {
    ...
    RoomObjects currentRoomObject, lastRoomObject;
    ...
    public void getRoom(RoomObjects roomObjects) {
        ...
        switch (roomObjects) {
            ...
            case RoomObjects.ENTRY_ROOM_BASE -> {
                ...
                RoomObjects[] nextRooms = {RoomObjects.GRAND_DINING_HALL_BASE, RoomObjects.WALL, RoomObjects.DARK_BASEMENT_BASE, RoomObjects.WALL};
            ...
            case RoomObjects.GRAND_DINING_HALL_BASE -> {
                ...
                RoomObjects[] nextRooms = {RoomObjects.WALL, RoomObjects.BAMBOO_FOREST_START_BASE, RoomObjects.ENTRY_ROOM_BASE, RoomObjects.SUSPICIOUSLY_CLEAN_BATHROOM_BASE};
            }
            ...
            case RoomObjects.DARK_BASEMENT_BASE -> {
                ...
                RoomObjects[] nextRooms = {RoomObjects.ENTRY_ROOM_BASE, RoomObjects.WALL, RoomObjects.WALL, RoomObjects.WALL};
            }
            ...
            case RoomObjects.BAMBOO_FOREST_START_BASE -> {
                ...
                RoomObjects[] nextRooms = {RoomObjects.BAMBOO_FOREST_CANYON_BRIDGE_BASE, RoomObjects.WALL, RoomObjects.WALL, RoomObjects.GRAND_DINING_HALL_BASE};
            }
            ...
            case RoomObjects.BAMBOO_FOREST_CANYON_BRIDGE_BASE -> {
                ...
                RoomObjects[] nextRooms = {RoomObjects.BAMBOO_FOREST_TURNBACK_BASE, RoomObjects.BAMBOO_FOREST_CANYON_RIVER_BASE, RoomObjects.BAMBOO_FOREST_START_BASE, RoomObjects.WALL};
            }
            ...
            case RoomObjects.BAMBOO_FOREST_TURNBACK_BASE -> {
                ...
                RoomObjects[] nextRooms = {RoomObjects.WALL, RoomObjects.WALL, RoomObjects.BAMBOO_FOREST_CANYON_BRIDGE_BASE, RoomObjects.WALL};
            }
            ...
            case RoomObjects.BAMBOO_FOREST_CANYON_RIVER_BASE -> {
                ...
                RoomObjects[] nextRooms = {RoomObjects.WALL, RoomObjects.WALL, RoomObjects.SECRET_DWARVEN_HALLWAY_BASE, RoomObjects.BAMBOO_FOREST_CANYON_BRIDGE_BASE};
            }
            ...
            case RoomObjects.SECRET_DWARVEN_HALLWAY_BASE -> {
                ...
                RoomObjects[] nextRooms = {RoomObjects.WALL, RoomObjects.BAMBOO_FOREST_CANYON_RIVER_BASE, RoomObjects.WALL, RoomObjects.DARK_BASEMENT_BASE};
            }
            ...
            case RoomObjects.SUSPICIOUSLY_CLEAN_BATHROOM_BASE -> {
                ...
                RoomObjects[] nextRooms = {RoomObjects.WALL, RoomObjects.GRAND_DINING_HALL_BASE, RoomObjects.WALL, RoomObjects.WALL};
